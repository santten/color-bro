...
const ColorGenerator = ({
    ...
    const randomizeColor = (typeArray) => {
        ...
        typeArray.forEach(item => {
            ...
            let randomHex = ((1 << 24) + (r << 16) + (g << 8) + b).toString(16).slice(1);
    ...
    return (
        <div>
            ...
            <button className="randomizeall" onClick={() => randomizeColor([])}>Randomize All Colors</button>
        </div>
    )
}
